        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} md={7}>
            ...
            <Typography sx={{ color: 'text.secondary', mb: 2, ml: { xs: 0, md: 4 } }}>
              Si tienes un presupuesto limitado o si te gusta organizar eventos, organizar tu evento tú mismo es
              definitivamente una opción. Descubre las ventajas y desventajas de organizar tú mismo el evento de tu
              empresa frente a la subcontratación de una agencia de eventos .
            </Typography>
